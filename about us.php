...
<div class="kolom12">
	...
	$query = "SELECT * FROM penghasilan"; // Query untuk menampilkan semua data siswa
	...
	while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
		...
		echo "<td>".$data['id']."</td>";
		echo "<td>".$data['nama_penghasilan']."</td>";
